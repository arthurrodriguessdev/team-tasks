...
from tarefa.views import criar_tarefa, listar_tarefas, visualizar_tarefa, excluir_tarefa, editar_tarefa, listar_minhas_tarefas


urlpatterns = [
    path('tarefas_equipe/', listar_tarefas, name='listagem_tarefas'),
    path('minhas_tarefas/', listar_minhas_tarefas, name='minhas_tarefas'),
